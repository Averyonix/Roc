...
auto gpu_get_required_format_features(GpuFormat, Flags<GpuImageUsage>) -> VkFormatFeatureFlags2;

auto gpu_find_memory_type_index(Gpu*, u32 type_filter, VkMemoryPropertyFlags required, VkMemoryPropertyFlags disallowed = {}) -> std::optional<u32>;
